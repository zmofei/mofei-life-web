    ...
    <>
      ...
      <div className='container max-w-[2000px] m-auto relative z-10'>
        <div className='overflow-hidden font-extrabold px-5 md:px-10 lg:px-16'>
          ...
          <p className="text-gray-300/90 text-lg md:text-xl lg:text-2xl font-medium leading-relaxed tracking-wide">
            {subtitleTexts[lang]}
          </p>

          <p className="text-gray-400/80 text-sm md:text-base leading-relaxed mt-4 md:mt-6">
            {lang === 'zh'

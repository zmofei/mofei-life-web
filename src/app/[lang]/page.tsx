            ...
            >
              ...
              >
                <Image 
                  ...
                  width={20} 
                  height={20} 
                  className="h-5 w-5 md:h-10 md:w-10 mx-auto mt-10" 
        ...
        <div className="h-svh w-full flex relative justify-center snap-start bg-black overflow-hidden">
          <div className='w-full max-w-screen-2xl leading-normal
            ...
            >
              ...
              >
                <Image 
                  src="/img/travel-svgrepo-com.svg" 
                  alt="Travel icon" 
                  width={56} 
                  height={56} 
                  className="h-14 block ml-auto mr-auto md:inline-block md:mr-2 md:ml-0" 
                  sizes="56px"
                  priority={false}
                />
            ...
            <motion.div
              className={`z-20 relative leading-loose 
                px-5 text-base mt-4 pb-32
                md:px-10 md:text-2xl md:mt-10 md:pb-40
              `}
              initial={{ opacity: 0, }} // 初始状态
              whileInView={{ opacity: 1, }} // 在视口内时触发动画
              viewport={{ amount: 0.2 }} // 配置触发条件：只触发一次，当 20% 进入视口时
